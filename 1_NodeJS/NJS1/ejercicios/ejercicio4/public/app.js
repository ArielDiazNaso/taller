  ...
  try {
    ...
    content.innerHTML = `
      <table>
        ...
        <tbody>
          <tr><td>Suma (5+3)</td><td>${data.suma}</td></tr>
          <tr><td>Resta (8-6)</td><td>${data.resta}</td></tr>
          <tr><td>Multiplicación (3*11)</td><td>${data.multiplicacion}</td></tr>
          <tr><td>División (30/5)</td><td>${data.division}</td></tr>
        </tbody>
      </table>
    `;
